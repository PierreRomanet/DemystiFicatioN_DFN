...
c
		...
		integer, save :: isourcesort,iisource
		integer, save :: ichargesort,idipstrsort
		integer, save :: ipot,igrad,ihess,itargetsort,iitarget
		integer, save :: ipottarg,igradtarg,ihesstarg
		integer, save :: iiaddr, irmlexp, imptemp, lmptemp
		integer, save :: iwlists,lwlists
		real *8, save :: epsfmm
        integer, save :: nboxes, nlev 
        integer, save :: flag_tree=0
c
c
        real *8 source(2,*)
        complex *16 charge(*)
...
c
        integer, save :: laddr(2,1000)     ! Change to 1000
        real *8, save :: scale(0:1000)
        real *8, save :: bsize(0:1000)
        integer, save :: nterms(0:1000)
c       
...
c       
        ...
        real *8, allocatable, save :: wlists(:)
        real *8, allocatable, save :: wrmlexp(:)
c
