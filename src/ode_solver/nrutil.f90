...
SUBROUTINE swap_rd(a,b)
REAL(DP), INTENT(INOUT) :: a,b
REAL(DP) :: dum
dum=a
a=b
b=dum
END SUBROUTINE swap_rd




SUBROUTINE swap_rvd(a,b)
REAL(DP), DIMENSION(:), INTENT(INOUT) :: a,b
REAL(DP), DIMENSION(SIZE(a)) :: dum
dum=a
a=b
b=dum
END SUBROUTINE swap_rvd
...
!Index of .rst occurrence of .true. in a logical vector.
LOGICAL(LGT), DIMENSION(:), INTENT(IN) :: mask
...
!Routines for “outer” operations on vectors. The order convention is: result(i,j) = .rst operand(i)
!(op) second operand(j).
